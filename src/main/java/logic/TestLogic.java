...
public class TestLogic implements VelenEvent, VelenSlashEvent {
    public static void setTestCommand(Velen velen) {
        ...
        VelenCommand.ofHybrid("test", "Rolls some dice with opportunities disabled!", velen, testLogic, testLogic).addOptions(options.toArray(new SlashCommandOption[0])).addShortcuts("t").setServerOnly(true, 468046159781429250L).attach();
    }
