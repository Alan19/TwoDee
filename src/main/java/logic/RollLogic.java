...
public class RollLogic implements VelenSlashEvent, VelenEvent {
    ...
    static List<SlashCommandOption> getRollCommandOptions() {
        ...
        options.add(SlashCommandOption.create(SlashCommandOptionType.NUMBER, "discount", "The number of plot points to discount (negative results in a plot point cost increase).", false));
        options.add(SlashCommandOption.create(SlashCommandOptionType.NUMBER, "dicekept", "The number of dice kept. Keeps two dice by default.", false));
