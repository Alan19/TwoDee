...
public class DiceRoller {
    ...
    public DiceRoller(String content) {
        ...
        DiceParameterHandler diceParameterHandler = new DiceParameterHandler(args, regDice, plotDice, flat);
    ...
    public EmbedBuilder generateResults(MessageAuthor author) {
        ...
        //Sum up total
        int total = getTotal(topTwo, plotResult, flatResult);
        //Build embed
        return buildResultEmbed(author, diceResults, pdResults, topTwo, dropped, total, flatResult);
    }
    ...
    private EmbedBuilder buildResultEmbed(MessageAuthor author, ArrayList<Integer> diceResults, ArrayList<Integer> pdResults, ArrayList<Integer> topTwo, ArrayList<Integer> dropped, int total, int flatResult) {
    ...
    private int getTotal(ArrayList<Integer> topTwo, int plotResult, int flatResult) {
        return topTwo.stream().mapToInt(Integer::intValue).sum() + plotResult + flatResult;
    }
